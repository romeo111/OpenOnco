...
| `uncited` | 1095 | 81.1% | 51.6% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 256 / 1351 = 18.9% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 180 / 1351 = 13.3%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-FL` — Follicular Lymphoma | 7 | 27 | 25 | 2 | 0 | 100.0% |
...
| `DIS-FL` — Follicular Lymphoma | 7 | 27 | 8 | 25 | 2 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-FL` — Follicular Lymphoma | 27 | 25 | 2 | 0 | 100.0% |
