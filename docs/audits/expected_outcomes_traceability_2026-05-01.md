...
| `uncited` | 1097 | 81.2% | 51.6% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 254 / 1351 = 18.8% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 178 / 1351 = 13.2%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-B-ALL` — B-Lymphoblastic Leukemia / Lymphoma | 6 | 24 | 23 | 1 | 0 | 100.0% |
...
| `DIS-B-ALL` — B-Lymphoblastic Leukemia / Lymphoma | 6 | 24 | 6 | 23 | 1 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-B-ALL` — B-Lymphoblastic Leukemia / Lymphoma | 24 | 23 | 1 | 0 | 100.0% |
