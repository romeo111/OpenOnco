...
|---|---:|---:|---:|
| `cited` | 176 | 13.0% | 8.3% |
| `probably-cited` | 68 | 5.0% | 3.2% |
| `uncited` | 1107 | 81.9% | 52.1% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 244 / 1351 = 18.1% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 176 / 1351 = 13.0%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-GASTRIC` — Gastric / GEJ adenocarcinoma | 6 | 25 | 25 | 0 | 0 | 100.0% |
...
| `DIS-GASTRIC` — Gastric / GEJ adenocarcinoma | 6 | 25 | 7 | 25 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-GASTRIC` — Gastric / GEJ adenocarcinoma | 25 | 25 | 0 | 0 | 100.0% |
