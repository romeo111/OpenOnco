...
| `uncited` | 1108 | 82.0% | 52.2% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 243 / 1351 = 18.0% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 167 / 1351 = 12.4%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-NLPBL` — Nodular Lymphocyte-Predominant B-cell Lymphoma (formerly NLPHL) | 3 | 12 | 12 | 0 | 0 | 100.0% |
...
| `DIS-NLPBL` — Nodular Lymphocyte-Predominant B-cell Lymphoma (formerly NLPHL) | 3 | 12 | 3 | 12 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-NLPBL` — Nodular Lymphocyte-Predominant B-cell Lymphoma (formerly NLPHL) | 12 | 12 | 0 | 0 | 100.0% |
