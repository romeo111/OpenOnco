...
- **Outcome-field slots (populated + absent):** 1617
- **Populated outcome-field slots:** 1070

| Bucket | Count | % of populated | % of all slots |
|---|---:|---:|---:|
| `cited` | 100 | 9.3% | 6.2% |
| `probably-cited` | 68 | 6.4% | 4.2% |
| `uncited` | 902 | 84.3% | 55.8% |
| `absent` | 547 | n/a | 33.8% |

**Combined `cited + probably-cited`:** 168 / 1070 = 15.7% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 100 / 1070 = 9.3%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-CRC` — Colorectal carcinoma (CRC) | 18 | 68 | 55 | 6 | 7 | 19.1% |
| 2 | `DIS-NSCLC` — Non-small cell lung cancer | 29 | 82 | 52 | 4 | 26 | 36.6% |
| 3 | `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 14 | 56 | 51 | 1 | 4 | 8.9% |
| 4 | `DIS-OVARIAN` — Ovarian carcinoma (high-grade serous predominant) | 15 | 48 | 42 | 2 | 4 | 12.5% |
| 5 | `DIS-DLBCL-NOS` — Diffuse Large B-Cell Lymphoma, NOS | 9 | 36 | 30 | 3 | 3 | 16.7% |
| 6 | `DIS-MELANOMA` — Cutaneous melanoma | 11 | 37 | 28 | 0 | 9 | 24.3% |
| 7 | `DIS-FL` — Follicular Lymphoma | 7 | 27 | 25 | 2 | 0 | 7.4% |
| 8 | `DIS-PV` — Polycythemia Vera | 6 | 24 | 24 | 0 | 0 | 0.0% |
| 9 | `DIS-B-ALL` — B-Lymphoblastic Leukemia / Lymphoma | 6 | 24 | 23 | 1 | 0 | 4.2% |
| 10 | `DIS-MM` — Multiple Myeloma | 7 | 28 | 22 | 6 | 0 | 21.4% |
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-HNSCC` — Head and neck squamous cell carcinoma (HNSCC) | 3 | 9 | 6 | 0 | 3 | 66.7% |
| 2 | `DIS-BREAST` — Breast cancer (invasive) | 20 | 39 | 21 | 1 | 17 | 56.4% |
| 3 | `DIS-MTC` — Medullary thyroid carcinoma (MTC) | 2 | 6 | 3 | 0 | 3 | 50.0% |
| 4 | `DIS-SCLC` — Small cell lung cancer | 2 | 2 | 0 | 1 | 1 | 50.0% |
| 5 | `DIS-GASTRIC` — Gastric / GEJ adenocarcinoma | 6 | 23 | 0 | 10 | 13 | 43.5% |
| 6 | `DIS-CERVICAL` — Cervical carcinoma (squamous predominant + adeno) | 2 | 8 | 3 | 0 | 5 | 37.5% |
| 7 | `DIS-NSCLC` — Non-small cell lung cancer | 29 | 82 | 26 | 4 | 52 | 36.6% |
| 8 | `DIS-ESOPHAGEAL` — Esophageal carcinoma (squamous + adeno) | 4 | 14 | 0 | 5 | 9 | 35.7% |
| 9 | `DIS-CLL` — Chronic Lymphocytic Leukemia / Small Lymphocytic Lymphoma | 6 | 24 | 0 | 7 | 17 | 29.2% |
| 10 | `DIS-ENDOMETRIAL` — Endometrial carcinoma | 5 | 14 | 0 | 4 | 10 | 28.6% |
...
| `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 14 | 56 | 14 | 4 | 1 | 51 | 8.9% |
...
| `DIS-BREAST` — Breast cancer (invasive) | 20 | 39 | 84 | 21 | 1 | 17 | 56.4% |
| `DIS-BURKITT` — Burkitt Lymphoma | 5 | 20 | 5 | 0 | 0 | 20 | 0.0% |
| `DIS-CERVICAL` — Cervical carcinoma (squamous predominant + adeno) | 2 | 8 | 2 | 3 | 0 | 5 | 37.5% |
| `DIS-CHL` — Classical Hodgkin Lymphoma | 7 | 28 | 7 | 2 | 5 | 21 | 25.0% |
| `DIS-CHOLANGIOCARCINOMA` — Cholangiocarcinoma (bile duct cancer) | 2 | 4 | 6 | 0 | 0 | 4 | 0.0% |
| `DIS-CHONDROSARCOMA` — Chondrosarcoma | 1 | 0 | 5 | 0 | 0 | 0 | 0.0% |
| `DIS-CLL` — Chronic Lymphocytic Leukemia / Small Lymphocytic Lymphoma | 6 | 24 | 6 | 0 | 7 | 17 | 29.2% |
| `DIS-CML` — Chronic Myeloid Leukemia (BCR-ABL1) | 5 | 20 | 5 | 0 | 1 | 19 | 5.0% |
| `DIS-CRC` — Colorectal carcinoma (CRC) | 18 | 68 | 22 | 7 | 6 | 55 | 19.1% |
| `DIS-DLBCL-NOS` — Diffuse Large B-Cell Lymphoma, NOS | 9 | 36 | 9 | 3 | 3 | 30 | 16.7% |
| `DIS-EATL` — Enteropathy-Associated T-Cell Lymphoma | 2 | 8 | 2 | 0 | 0 | 8 | 0.0% |
| `DIS-ENDOMETRIAL` — Endometrial carcinoma | 5 | 14 | 13 | 0 | 4 | 10 | 28.6% |
| `DIS-ESOPHAGEAL` — Esophageal carcinoma (squamous + adeno) | 4 | 14 | 6 | 0 | 5 | 9 | 35.7% |
| `DIS-ET` — Essential Thrombocythemia | 3 | 12 | 3 | 0 | 0 | 12 | 0.0% |
| `DIS-FL` — Follicular Lymphoma | 7 | 27 | 8 | 0 | 2 | 25 | 7.4% |
| `DIS-GASTRIC` — Gastric / GEJ adenocarcinoma | 6 | 23 | 7 | 0 | 10 | 13 | 43.5% |
| `DIS-GBM` — Glioblastoma (IDH-WT, WHO grade 4) | 1 | 3 | 2 | 0 | 0 | 3 | 0.0% |
| `DIS-GIST` — Gastrointestinal stromal tumor (GIST) | 2 | 6 | 4 | 0 | 0 | 6 | 0.0% |
| `DIS-GLIOMA-LOW-GRADE` — Low-grade glioma (LGG, WHO grade 2 — IDH-mutant) | 1 | 3 | 2 | 0 | 0 | 3 | 0.0% |
| `DIS-HCC` — Hepatocellular carcinoma (HCC) | 3 | 12 | 3 | 0 | 3 | 9 | 25.0% |
...
| `DIS-HNSCC` — Head and neck squamous cell carcinoma (HNSCC) | 3 | 9 | 6 | 6 | 0 | 3 | 66.7% |
...
| `DIS-MCL` — Mantle Cell Lymphoma | 6 | 24 | 6 | 3 | 1 | 20 | 16.7% |
...
| `DIS-MM` — Multiple Myeloma | 7 | 28 | 7 | 0 | 6 | 22 | 21.4% |
...
| `DIS-NSCLC` — Non-small cell lung cancer | 29 | 82 | 73 | 26 | 4 | 52 | 36.6% |
...
| `DIS-PDAC` — Pancreatic ductal adenocarcinoma (PDAC) | 3 | 9 | 6 | 0 | 0 | 9 | 0.0% |
...
| `DIS-PROSTATE` — Prostate adenocarcinoma | 5 | 16 | 20 | 3 | 1 | 12 | 25.0% |
...
| `DIS-RCC` — Renal cell carcinoma | 4 | 7 | 18 | 0 | 2 | 5 | 28.6% |
| `DIS-SALIVARY` — Salivary gland carcinoma | 1 | 0 | 5 | 0 | 0 | 0 | 0.0% |
| `DIS-SCLC` — Small cell lung cancer | 2 | 2 | 10 | 0 | 1 | 1 | 50.0% |
...
| `DIS-THYROID-ANAPLASTIC` — Anaplastic thyroid carcinoma (ATC) | 1 | 0 | 5 | 0 | 0 | 0 | 0.0% |
| `DIS-THYROID-PAPILLARY` — Papillary thyroid carcinoma (PTC) | 1 | 0 | 5 | 0 | 0 | 0 | 0.0% |
| `DIS-UROTHELIAL` — Urothelial carcinoma (bladder + upper tract) | 2 | 2 | 10 | 0 | 0 | 2 | 0.0% |
...
Indications: 18; populated: 68; cited: 7; probably-cited: 6; uncited: 55; absent: 22.
...
Indications: 29; populated: 82; cited: 26; probably-cited: 4; uncited: 52; absent: 73.
...
Indications: 14; populated: 56; cited: 4; probably-cited: 1; uncited: 51; absent: 14.
...
|---|---|---:|---:|---:|---:|---|
| NSCLC | `DIS-NSCLC` | 82 | 52 | 26 | 36.6% | prioritize as planned |
| Breast | `DIS-BREAST` | 39 | 17 | 21 | 56.4% | prioritize as planned |
| CRC | `DIS-CRC` | 68 | 55 | 7 | 19.1% | prioritize as planned |
| Prostate | `DIS-PROSTATE` | 16 | 12 | 3 | 25.0% | prioritize as planned |
| AML | `DIS-AML` | 56 | 51 | 4 | 8.9% | prioritize as planned |
| DLBCL | `DIS-DLBCL-NOS` | 36 | 30 | 3 | 16.7% | prioritize as planned |
...
| `DIS-B-ALL` — B-Lymphoblastic Leukemia / Lymphoma | 24 | 23 | 0 | 4.2% |
| `DIS-MM` — Multiple Myeloma | 28 | 22 | 0 | 21.4% |

### Diseases better than plan assumes (skip / defer)

_No diseases meet the (≥4 populated outcomes AND ≥80% loose-cited) skip threshold._

---

_Generated by `scripts/audit_expected_outcomes.py` on 2026-05-01. Indications audited: 312. Underlying KB tree: `knowledge_base/hosted/content/`._
