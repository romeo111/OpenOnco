...
**Combined `cited + probably-cited`:** 252 / 1351 = 18.7% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 181 / 1351 = 13.4%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-CHL` — Classical Hodgkin Lymphoma | 7 | 28 | 28 | 0 | 0 | 100.0% |
...
| `DIS-CHL` — Classical Hodgkin Lymphoma | 7 | 28 | 7 | 28 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-CHL` — Classical Hodgkin Lymphoma | 28 | 28 | 0 | 0 | 100.0% |
