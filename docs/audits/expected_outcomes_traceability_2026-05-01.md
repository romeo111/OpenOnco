...
**Combined `cited + probably-cited`:** 246 / 1351 = 18.2% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 171 / 1351 = 12.7%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-PTCL-NOS` — Peripheral T-Cell Lymphoma, Not Otherwise Specified | 4 | 16 | 16 | 0 | 0 | 100.0% |
...
| `DIS-PTCL-NOS` — Peripheral T-Cell Lymphoma, Not Otherwise Specified | 4 | 16 | 4 | 16 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-PTCL-NOS` — Peripheral T-Cell Lymphoma, Not Otherwise Specified | 16 | 16 | 0 | 0 | 100.0% |
