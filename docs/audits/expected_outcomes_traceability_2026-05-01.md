...
| `uncited` | 1094 | 81.0% | 51.5% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 257 / 1351 = 19.0% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 181 / 1351 = 13.4%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-MDS-LR` — Myelodysplastic Syndromes — Lower-Risk (IPSS-R very low / low / intermediate) | 4 | 16 | 16 | 0 | 0 | 100.0% |
| 2 | `DIS-MDS-HR` — Myelodysplastic Syndromes — Higher-Risk (IPSS-R high / very high; includes MDS-EB) | 3 | 12 | 12 | 0 | 0 | 100.0% |
| 3 | `DIS-HNSCC` — Head and neck squamous cell carcinoma (HNSCC) | 5 | 21 | 18 | 0 | 3 | 85.7% |
| 4 | `DIS-ESOPHAGEAL` — Esophageal carcinoma (squamous + adeno) | 6 | 20 | 6 | 5 | 9 | 55.0% |
| 5 | `DIS-BREAST` — Breast cancer (invasive) | 26 | 47 | 23 | 2 | 22 | 53.2% |
| 6 | `DIS-MTC` — Medullary thyroid carcinoma (MTC) | 2 | 6 | 3 | 0 | 3 | 50.0% |
| 7 | `DIS-GASTRIC` — Gastric / GEJ adenocarcinoma | 6 | 25 | 4 | 8 | 13 | 48.0% |
| 8 | `DIS-RCC` — Renal cell carcinoma | 8 | 18 | 2 | 5 | 11 | 38.9% |
| 9 | `DIS-PROSTATE` — Prostate adenocarcinoma | 8 | 35 | 10 | 1 | 24 | 31.4% |
| 10 | `DIS-NSCLC` — Non-small cell lung cancer | 40 | 120 | 33 | 4 | 83 | 30.8% |
...
| `DIS-MDS-HR` — Myelodysplastic Syndromes — Higher-Risk (IPSS-R high / very high; includes MDS-EB) | 3 | 12 | 3 | 12 | 0 | 0 | 100.0% |
| `DIS-MDS-LR` — Myelodysplastic Syndromes — Lower-Risk (IPSS-R very low / low / intermediate) | 4 | 16 | 4 | 16 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-MDS-LR` — Myelodysplastic Syndromes — Lower-Risk (IPSS-R very low / low / intermediate) | 16 | 16 | 0 | 0 | 100.0% |
| `DIS-MDS-HR` — Myelodysplastic Syndromes — Higher-Risk (IPSS-R high / very high; includes MDS-EB) | 12 | 12 | 0 | 0 | 100.0% |
