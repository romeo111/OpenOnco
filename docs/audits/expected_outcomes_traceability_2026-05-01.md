...
| `uncited` | 1102 | 81.6% | 51.9% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 249 / 1351 = 18.4% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 174 / 1351 = 12.9%.
...
| 3 | `DIS-OVARIAN` — Ovarian carcinoma (high-grade serous predominant) | 15 | 48 | 42 | 2 | 4 | 12.5% |
| 4 | `DIS-DLBCL-NOS` — Diffuse Large B-Cell Lymphoma, NOS | 12 | 48 | 42 | 4 | 2 | 12.5% |
| 5 | `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 15 | 60 | 37 | 0 | 23 | 38.3% |
...
| 7 | `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 15 | 60 | 23 | 0 | 37 | 38.3% |
...
| `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 15 | 60 | 15 | 23 | 0 | 37 | 38.3% |
...
Indications: 15; populated: 48; cited: 4; probably-cited: 2; uncited: 42; absent: 27.
...
| AML | `DIS-AML` | 60 | 37 | 23 | 38.3% | prioritize as planned |
