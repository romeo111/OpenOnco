...
**Combined `cited + probably-cited`:** 240 / 1351 = 17.8% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 164 / 1351 = 12.1%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-CERVICAL` — Cervical carcinoma (squamous predominant + adeno) | 3 | 12 | 12 | 0 | 0 | 100.0% |
...
| `DIS-CERVICAL` — Cervical carcinoma (squamous predominant + adeno) | 3 | 12 | 3 | 12 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-CERVICAL` — Cervical carcinoma (squamous predominant + adeno) | 12 | 12 | 0 | 0 | 100.0% |
