...
| `uncited` | 1088 | 80.5% | 51.2% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 263 / 1351 = 19.5% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 187 / 1351 = 13.8%.
...
| 8 | `DIS-PROSTATE` — Prostate adenocarcinoma | 8 | 35 | 24 | 1 | 10 | 31.4% |
| 9 | `DIS-PV` — Polycythemia Vera | 6 | 24 | 24 | 0 | 0 | 0.0% |
| 10 | `DIS-MCL` — Mantle Cell Lymphoma | 7 | 28 | 23 | 2 | 3 | 17.9% |
...
| 2 | `DIS-OVARIAN` — Ovarian carcinoma (high-grade serous predominant) | 15 | 48 | 36 | 2 | 10 | 79.2% |
...
| `DIS-OVARIAN` — Ovarian carcinoma (high-grade serous predominant) | 15 | 48 | 27 | 36 | 2 | 10 | 79.2% |
...
| `DIS-MCL` — Mantle Cell Lymphoma | 28 | 23 | 3 | 17.9% |
