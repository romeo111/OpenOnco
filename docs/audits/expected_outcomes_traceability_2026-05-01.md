...
**Combined `cited + probably-cited`:** 250 / 1351 = 18.5% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 175 / 1351 = 13.0%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-CML` — Chronic Myeloid Leukemia (BCR-ABL1) | 5 | 20 | 20 | 0 | 0 | 100.0% |
...
| `DIS-CML` — Chronic Myeloid Leukemia (BCR-ABL1) | 5 | 20 | 5 | 20 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-CML` — Chronic Myeloid Leukemia (BCR-ABL1) | 20 | 20 | 0 | 0 | 100.0% |
