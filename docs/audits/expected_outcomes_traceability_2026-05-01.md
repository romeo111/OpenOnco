...
**Combined `cited + probably-cited`:** 254 / 1351 = 18.8% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 180 / 1351 = 13.3%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-MCL` — Mantle Cell Lymphoma | 7 | 28 | 28 | 0 | 0 | 100.0% |
...
| `DIS-MCL` — Mantle Cell Lymphoma | 7 | 28 | 7 | 28 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-MCL` — Mantle Cell Lymphoma | 28 | 28 | 0 | 0 | 100.0% |
