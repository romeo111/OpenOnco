...
|---|---:|---:|---:|
| `cited` | 201 | 14.9% | 9.5% |
| `probably-cited` | 72 | 5.3% | 3.4% |
| `uncited` | 1078 | 79.8% | 50.8% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 273 / 1351 = 20.2% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 201 / 1351 = 14.9%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-DLBCL-NOS` — Diffuse Large B-Cell Lymphoma, NOS | 12 | 48 | 48 | 0 | 0 | 100.0% |
...
| `DIS-DLBCL-NOS` — Diffuse Large B-Cell Lymphoma, NOS | 12 | 48 | 12 | 48 | 0 | 0 | 100.0% |
...
| DLBCL | `DIS-DLBCL-NOS` | 48 | 0 | 48 | 100.0% | **better than plan assumes — defer** |
...
|---|---:|---:|---:|---:|---:|
| `DIS-DLBCL-NOS` — Diffuse Large B-Cell Lymphoma, NOS | 48 | 48 | 0 | 0 | 100.0% |
