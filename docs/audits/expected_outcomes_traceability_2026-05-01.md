...
| `uncited` | 1099 | 81.3% | 51.7% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 252 / 1351 = 18.7% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 176 / 1351 = 13.0%.
...
| 6 | `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 15 | 60 | 34 | 1 | 25 | 43.3% |
...
| 6 | `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 15 | 60 | 25 | 1 | 34 | 43.3% |
...
| `DIS-AML` — Acute Myeloid Leukemia (non-APL) | 15 | 60 | 15 | 25 | 1 | 34 | 43.3% |
...
| AML | `DIS-AML` | 60 | 34 | 25 | 43.3% | prioritize as planned |
