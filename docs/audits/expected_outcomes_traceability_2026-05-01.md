...
**Combined `cited + probably-cited`:** 240 / 1351 = 17.8% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 165 / 1351 = 12.2%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-GIST` — Gastrointestinal stromal tumor (GIST) | 3 | 10 | 10 | 0 | 0 | 100.0% |
...
| `DIS-GIST` — Gastrointestinal stromal tumor (GIST) | 3 | 10 | 5 | 10 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-GIST` — Gastrointestinal stromal tumor (GIST) | 10 | 10 | 0 | 0 | 100.0% |
