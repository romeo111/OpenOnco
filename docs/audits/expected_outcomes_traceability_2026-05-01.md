...
| `uncited` | 1106 | 81.9% | 52.1% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 245 / 1351 = 18.1% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 169 / 1351 = 12.5%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-HCV-MZL` — HCV-associated Marginal Zone Lymphoma | 3 | 14 | 14 | 0 | 0 | 100.0% |
...
| `DIS-HCV-MZL` — HCV-associated Marginal Zone Lymphoma | 3 | 14 | 1 | 14 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-HCV-MZL` — HCV-associated Marginal Zone Lymphoma | 14 | 14 | 0 | 0 | 100.0% |
