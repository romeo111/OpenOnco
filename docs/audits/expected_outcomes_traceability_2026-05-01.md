...
|---|---:|---:|---:|
| `cited` | 195 | 14.4% | 9.2% |
| `probably-cited` | 73 | 5.4% | 3.4% |
| `uncited` | 1083 | 80.2% | 51.0% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 268 / 1351 = 19.8% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 195 / 1351 = 14.4%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-MM` — Multiple Myeloma | 13 | 52 | 43 | 9 | 0 | 100.0% |
...
| `DIS-MM` — Multiple Myeloma | 13 | 52 | 19 | 43 | 9 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-MM` — Multiple Myeloma | 52 | 43 | 9 | 0 | 100.0% |
