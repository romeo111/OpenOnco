...
**Combined `cited + probably-cited`:** 242 / 1351 = 17.9% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 166 / 1351 = 12.3%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-CHOLANGIOCARCINOMA` — Cholangiocarcinoma (bile duct cancer) | 4 | 11 | 11 | 0 | 0 | 100.0% |
...
| `DIS-CHOLANGIOCARCINOMA` — Cholangiocarcinoma (bile duct cancer) | 4 | 11 | 9 | 11 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-CHOLANGIOCARCINOMA` — Cholangiocarcinoma (bile duct cancer) | 11 | 11 | 0 | 0 | 100.0% |
