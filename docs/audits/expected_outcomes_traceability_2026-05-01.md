...
| `uncited` | 1098 | 81.3% | 51.7% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 253 / 1351 = 18.7% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 177 / 1351 = 13.1%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-BREAST` — Breast cancer (invasive) | 26 | 47 | 45 | 2 | 0 | 100.0% |
...
| `DIS-BREAST` — Breast cancer (invasive) | 26 | 47 | 112 | 45 | 2 | 0 | 100.0% |
...
| Breast | `DIS-BREAST` | 47 | 0 | 45 | 100.0% | **better than plan assumes — defer** |
...
|---|---:|---:|---:|---:|---:|
| `DIS-BREAST` — Breast cancer (invasive) | 47 | 45 | 2 | 0 | 100.0% |
