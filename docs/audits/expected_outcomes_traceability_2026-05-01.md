...
| `uncited` | 1117 | 82.7% | 52.6% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 234 / 1351 = 17.3% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 158 / 1351 = 11.7%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-HNSCC` — Head and neck squamous cell carcinoma (HNSCC) | 5 | 21 | 21 | 0 | 0 | 100.0% |
...
| 7 | `DIS-PROSTATE` — Prostate adenocarcinoma | 8 | 35 | 10 | 1 | 24 | 31.4% |
| 8 | `DIS-NSCLC` — Non-small cell lung cancer | 40 | 120 | 33 | 4 | 83 | 30.8% |
...
| `DIS-HNSCC` — Head and neck squamous cell carcinoma (HNSCC) | 5 | 21 | 15 | 21 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-HNSCC` — Head and neck squamous cell carcinoma (HNSCC) | 21 | 21 | 0 | 0 | 100.0% |
