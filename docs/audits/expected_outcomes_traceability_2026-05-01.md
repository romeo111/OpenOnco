...
| `uncited` | 1109 | 82.1% | 52.2% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 242 / 1351 = 17.9% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 171 / 1351 = 12.7%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-RCC` — Renal cell carcinoma | 8 | 18 | 18 | 0 | 0 | 100.0% |
...
| `DIS-RCC` — Renal cell carcinoma | 8 | 18 | 32 | 18 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-RCC` — Renal cell carcinoma | 18 | 18 | 0 | 0 | 100.0% |
