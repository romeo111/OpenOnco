...
|---|---:|---:|---:|
| `cited` | 169 | 12.5% | 8.0% |
| `probably-cited` | 71 | 5.3% | 3.3% |
| `uncited` | 1111 | 82.2% | 52.3% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 240 / 1351 = 17.8% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 169 / 1351 = 12.5%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-ESOPHAGEAL` — Esophageal carcinoma (squamous + adeno) | 6 | 20 | 20 | 0 | 0 | 100.0% |
...
| `DIS-ESOPHAGEAL` — Esophageal carcinoma (squamous + adeno) | 6 | 20 | 12 | 20 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-ESOPHAGEAL` — Esophageal carcinoma (squamous + adeno) | 20 | 20 | 0 | 0 | 100.0% |
