...
| `uncited` | 1114 | 82.5% | 52.4% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 237 / 1351 = 17.5% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 161 / 1351 = 11.9%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-MASTOCYTOSIS` — Advanced systemic mastocytosis (AdvSM) | 2 | 6 | 6 | 0 | 0 | 100.0% |
...
| `DIS-MASTOCYTOSIS` — Advanced systemic mastocytosis (AdvSM) | 2 | 6 | 4 | 6 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-MASTOCYTOSIS` — Advanced systemic mastocytosis (AdvSM) | 6 | 6 | 0 | 0 | 100.0% |
