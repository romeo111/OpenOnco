...
| `uncited` | 1104 | 81.7% | 52.0% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 247 / 1351 = 18.3% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 171 / 1351 = 12.7%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-APL` — Acute Promyelocytic Leukemia (PML-RARA) | 4 | 16 | 16 | 0 | 0 | 100.0% |
...
| `DIS-APL` — Acute Promyelocytic Leukemia (PML-RARA) | 4 | 16 | 4 | 16 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-APL` — Acute Promyelocytic Leukemia (PML-RARA) | 16 | 16 | 0 | 0 | 100.0% |
