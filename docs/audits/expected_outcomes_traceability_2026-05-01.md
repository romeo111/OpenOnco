...
| `uncited` | 1096 | 81.1% | 51.6% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 255 / 1351 = 18.9% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 180 / 1351 = 13.3%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-PROSTATE` — Prostate adenocarcinoma | 8 | 35 | 35 | 0 | 0 | 100.0% |
...
| `DIS-PROSTATE` — Prostate adenocarcinoma | 8 | 35 | 35 | 35 | 0 | 0 | 100.0% |
...
| Prostate | `DIS-PROSTATE` | 35 | 0 | 35 | 100.0% | **better than plan assumes — defer** |
...
|---|---:|---:|---:|---:|---:|
| `DIS-PROSTATE` — Prostate adenocarcinoma | 35 | 35 | 0 | 0 | 100.0% |
