...
**Combined `cited + probably-cited`:** 255 / 1351 = 18.9% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 179 / 1351 = 13.2%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-PV` — Polycythemia Vera | 6 | 24 | 24 | 0 | 0 | 100.0% |
...
| `DIS-PV` — Polycythemia Vera | 6 | 24 | 6 | 24 | 0 | 0 | 100.0% |
...
|---|---:|---:|---:|---:|---:|
| `DIS-PV` — Polycythemia Vera | 24 | 24 | 0 | 0 | 100.0% |
