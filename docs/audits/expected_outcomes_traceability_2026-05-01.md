...
|---|---:|---:|---:|
| `cited` | 161 | 11.9% | 7.6% |
| `probably-cited` | 75 | 5.6% | 3.5% |
| `uncited` | 1115 | 82.5% | 52.5% |
| `absent` | 773 | n/a | 36.4% |

**Combined `cited + probably-cited`:** 236 / 1351 = 17.5% of populated outcome values carry a citation pointer (loose definition). Strict-cited only: 161 / 1351 = 11.9%.
...
|---:|---|---:|---:|---:|---:|---:|---:|
| 1 | `DIS-NSCLC` — Non-small cell lung cancer | 40 | 120 | 78 | 3 | 39 | 35.0% |
...
| 6 | `DIS-RCC` — Renal cell carcinoma | 8 | 18 | 2 | 5 | 11 | 38.9% |
| 7 | `DIS-NSCLC` — Non-small cell lung cancer | 40 | 120 | 39 | 3 | 78 | 35.0% |
| 8 | `DIS-PROSTATE` — Prostate adenocarcinoma | 8 | 35 | 10 | 1 | 24 | 31.4% |
| 9 | `DIS-MM` — Multiple Myeloma | 13 | 52 | 3 | 12 | 37 | 28.8% |
| 10 | `DIS-UROTHELIAL` — Urothelial carcinoma (bladder + upper tract) | 6 | 14 | 4 | 0 | 10 | 28.6% |
...
| `DIS-NSCLC` — Non-small cell lung cancer | 40 | 120 | 114 | 39 | 3 | 78 | 35.0% |
...
Indications: 40; populated: 120; cited: 39; probably-cited: 3; uncited: 78; absent: 114.
...
| IND-NSCLC-EGFR-MAINT-OSIMERTINIB | complete_response | cited | SRC-id hit: SRC-FLAURA-SORIA-2018 | ~3% (deep CR rare) SRC-FLAURA-SORIA-2018 |
| IND-NSCLC-EGFR-MAINT-OSIMERTINIB | overall_response_rate | cited | SRC-id hit: SRC-FLAURA-SORIA-2018 | ~80% during initial response phase (FLAURA) SRC-FLAURA-SORIA-2018 |
| IND-NSCLC-EGFR-MAINT-OSIMERTINIB | overall_survival_5y | cited | SRC-id hit: SRC-FLAURA-SORIA-2018 | Median OS ~38.6 mo vs ~31.8 mo with 1st-gen TKI (FLAURA OS update, Ramalingam 2020) SRC-FLAURA-SORIA-2018 Final OS an... |
| IND-NSCLC-EGFR-MAINT-OSIMERTINIB | progression_free_survival | cited | SRC-id hit: SRC-FLAURA-SORIA-2018 | Median PFS ~18.9 mo (FLAURA Soria 2018, Ramalingam 2020 update) SRC-FLAURA-SORIA-2018 Ramalingam 2020 NEJM OS final u... |
...
| IND-NSCLC-ELDERLY-CARBO-PEM-MOD | complete_response | cited | SRC-id hit: SRC-NCCN-NSCLC-2025 | ~3% SRC-NCCN-NSCLC-2025 Estimate from NCCN guideline consensus for elderly modified-dose carbo-pem |
| IND-NSCLC-ELDERLY-CARBO-PEM-MOD | overall_response_rate | cited | SRC-id hit: SRC-NCCN-NSCLC-2025 | ~30% carbo + pem (extrapolated from JCOG 0803 elderly NSCLC; Quoix 2011 Lancet) SRC-NCCN-NSCLC-2025 Guideline-only ci... |
| IND-NSCLC-ELDERLY-CARBO-PEM-MOD | overall_survival_5y | cited | SRC-id hit: SRC-NCCN-NSCLC-2025 | Median OS ~10-14 mo (elderly cohorts; addition of pembro per KEYNOTE-189 may extend further) SRC-NCCN-NSCLC-2025 Guid... |
| IND-NSCLC-ELDERLY-CARBO-PEM-MOD | progression_free_survival | cited | SRC-id hit: SRC-NCCN-NSCLC-2025 | Median PFS ~5-6 mo (elderly cohorts; lower than fit cohorts) SRC-NCCN-NSCLC-2025 Guideline-only; no dedicated elderly... |
...
| IND-NSCLC-PDL1-HIGH-MET-1L | five_year_overall_survival | cited | SRC-id hit: SRC-KEYNOTE-024-RECK-2016 | 32% pembro mono vs 16% chemo (KEYNOTE-024 5-yr update) SRC-KEYNOTE-024-RECK-2016 5-year OS from KEYNOTE-024 long-term... |
| IND-NSCLC-PDL1-LOW-NONSQ-MET-1L | median_overall_survival_months | cited | trial-number resolved: KEYNOTE-189 | 22 |
| IND-NSCLC-PEMBRO-MAINTENANCE-POST-CHEMO | overall_response_rate | cited | SRC-id hit: SRC-KEYNOTE-189-GANDHI-2018 | Sustained from induction; maintenance deepens responses in ~10-15% SRC-KEYNOTE-189-GANDHI-2018 Response deepening est... |
| IND-NSCLC-PEMBRO-MAINTENANCE-POST-CHEMO | overall_survival_5y | cited | SRC-id hit: SRC-KEYNOTE-189-GANDHI-2018 | 5-year OS ~19-22% (KEYNOTE-189 5-year update; vs ~11% chemo alone) SRC-KEYNOTE-189-GANDHI-2018 5-year OS from KEYNOTE... |
| IND-NSCLC-PEMBRO-MAINTENANCE-POST-CHEMO | progression_free_survival | cited | SRC-id hit: SRC-KEYNOTE-189-GANDHI-2018 | Median PFS ~8.8 mo (KEYNOTE-189 non-squamous from start of 1L) SRC-KEYNOTE-189-GANDHI-2018 |
...
| IND-NSCLC-STAGE-III-PACIFIC | five_year_overall_survival | cited | SRC-id hit: SRC-PACIFIC-ANTONIA-2018 | 42.9% durva vs 33.4% placebo at 5 years (PACIFIC long-term) SRC-PACIFIC-ANTONIA-2018 5-yr OS from Spigel 2022 Ann Onc... |
| IND-NSCLC-TMB-HIGH-MET-1L-PEMBRO-MONO | median_overall_survival_months | cited | SRC-id hit: SRC-KEYNOTE-158-MARABELLE-2020 | Not reached at 11.7 mo median follow-up (KEYNOTE-158 NSCLC subset, n=37) SRC-KEYNOTE-158-MARABELLE-2020 NSCLC subset ... |
| IND-NSCLC-TMB-HIGH-MET-1L-PEMBRO-MONO | median_progression_free_survival_months | cited | SRC-id hit: SRC-KEYNOTE-158-MARABELLE-2020 | 4.1 mo (KEYNOTE-158 TMB-high subgroup; NSCLC subset extrapolation) SRC-KEYNOTE-158-MARABELLE-2020 PFS 4.1 mo from KEY... |
| IND-NSCLC-TMB-HIGH-MET-1L-PEMBRO-MONO | overall_response_rate | cited | SRC-id hit: SRC-KEYNOTE-158-MARABELLE-2020 | ORR 29% in TMB-high subgroup (vs 6% in TMB-low) per KEYNOTE-158 pan-tumor SRC-KEYNOTE-158-MARABELLE-2020 Pan-tumor OR... |
...
|---|---|---:|---:|---:|---:|---|
| NSCLC | `DIS-NSCLC` | 120 | 78 | 39 | 35.0% | prioritize as planned |
