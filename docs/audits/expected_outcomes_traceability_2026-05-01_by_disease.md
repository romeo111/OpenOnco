...
Indications: 3; populated: 12; cited: 12; probably-cited: 0; uncited: 0; absent: 3; outcomes-cited % (loose): 100.0%.

| Indication | Field | Bucket | Matched via | Value excerpt |
|---|---|---|---|---|
| IND-MDS-HR-1L-AZA | complete_response | cited | SRC-id hit: SRC-ESMO-MDS-2021 | CR ~17% (AZA-001) |
| IND-MDS-HR-1L-AZA | overall_response_rate | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~50% complete + partial response (azacitidine; AZA-001 trial) |
| IND-MDS-HR-1L-AZA | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~10-15% (HR-MDS without alloHCT); ~40-50% with alloHCT bridging |
| IND-MDS-HR-1L-AZA | progression_free_survival | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Median ~21 months (AZA-001 vs ~15 mo conventional care) |
| IND-MDS-HR-1L-VEN-AZA | complete_response | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Higher CR rates than aza alone in series; durability + OS benefit not yet phase-3 confirmed |
| IND-MDS-HR-1L-VEN-AZA | overall_response_rate | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~50-70% composite CR + CRi (extrapolated from VIALE-A AML; small phase-2 HR-MDS series; no phase-3 yet) |
| IND-MDS-HR-1L-VEN-AZA | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Insufficient data for HR-MDS-specific 5-y; alloHCT bridging is the path to long-term survival |
| IND-MDS-HR-1L-VEN-AZA | progression_free_survival | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Median PFS ~12-15 months in early studies |
| IND-MDS-HR-ALLOHCT | complete_response | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Durable molecular CR ~40-60% at 5 years for MDS-HR with optimal pre-HCT control |
| IND-MDS-HR-ALLOHCT | overall_response_rate | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~70-90% achieve disease control post-HCT (variable by pre-HCT blast burden) |
| IND-MDS-HR-ALLOHCT | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-MDS-2021 | 5-y OS 40-50% MDS-HR overall; substantially better than non-transplant (~10-15% 5-y OS) |
| IND-MDS-HR-ALLOHCT | progression_free_survival | cited | SRC-id hit: SRC-ESMO-MDS-2021 | 5-y PFS 35-50% for MDS-HR overall; 50-60% for IPSS-R high; 25-35% for very high; ~20-30% for TP53-mutated |
...
| Indication | Field | Bucket | Matched via | Value excerpt |
|---|---|---|---|---|
| IND-MDS-LR-1L-ESA | complete_response | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Transfusion independence ~30-40% |
| IND-MDS-LR-1L-ESA | overall_response_rate | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~50-60% Hb response in selected MDS-LR (endogenous EPO ≤500 mU/mL + RBC TD ≤2U/month) |
| IND-MDS-LR-1L-ESA | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Per IPSS-R: VL ~80%; L ~50-60%; Int ~30-40% |
| IND-MDS-LR-1L-ESA | progression_free_survival | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Cytopenia management; does not alter MDS natural history |
| IND-MDS-LR-1L-LUSPATERCEPT | complete_response | cited | SRC-id hit: SRC-COMMANDS-FENAUX-2020 | Transfusion independence ~50-60% |
| IND-MDS-LR-1L-LUSPATERCEPT | overall_response_rate | cited | SRC-id hit: SRC-COMMANDS-FENAUX-2020 | ~58% RBC transfusion independence ≥12 wk in COMMANDS (vs 31% ESA); ~38% TI ≥8 wk in MEDALIST 2L |
| IND-MDS-LR-1L-LUSPATERCEPT | overall_survival_5y | cited | SRC-id hit: SRC-COMMANDS-FENAUX-2020 | Per IPSS-R baseline |
| IND-MDS-LR-1L-LUSPATERCEPT | progression_free_survival | cited | SRC-id hit: SRC-COMMANDS-FENAUX-2020 | Cytopenia management; does not alter natural history |
| IND-MDS-LR-2L-IMETELSTAT | complete_response | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Sustained 24-week TI ~28% (vs 3.3% placebo) |
| IND-MDS-LR-2L-IMETELSTAT | overall_response_rate | cited | SRC-id hit: SRC-ESMO-MDS-2021 | 8-week RBC TI ~39.8% (IMerge; vs 15.0% placebo, p<0.001) |
| IND-MDS-LR-2L-IMETELSTAT | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Per IPSS-R / IPSS-M baseline; OS not significantly altered (cytopenia management indication) |
| IND-MDS-LR-2L-IMETELSTAT | progression_free_survival | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Cytopenia management; does not alter natural history; median TI duration ~52 weeks for responders |
| IND-MDS-LR-LENALIDOMIDE-DEL5Q | complete_response | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~20-25% achieve cytogenetic CR (loss of del(5q) clone) |
| IND-MDS-LR-LENALIDOMIDE-DEL5Q | overall_response_rate | cited | SRC-id hit: SRC-ESMO-MDS-2021 | ~56% RBC TI at 26 weeks (MDS-004; vs 5.9% placebo) |
| IND-MDS-LR-LENALIDOMIDE-DEL5Q | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Per IPSS-R baseline; lenalidomide does not alter natural history but improves QoL via TI |
| IND-MDS-LR-LENALIDOMIDE-DEL5Q | progression_free_survival | cited | SRC-id hit: SRC-ESMO-MDS-2021 | Median TI duration >2 years per MDS-004 |
