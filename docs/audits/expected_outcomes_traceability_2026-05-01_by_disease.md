...
| Indication | Field | Bucket | Matched via | Value excerpt |
|---|---|---|---|---|
| IND-ADVSM-1L-AVAPRITINIB | overall_response_rate | cited | SRC-id hit: SRC-ESMO-AML-2020 | ~75% (PATHFINDER advanced SM) |
| IND-ADVSM-1L-AVAPRITINIB | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-AML-2020 | ASM ~70% at 24 mo (vs historical ~50%); SM-AHN and MCL with concomitant AHN-directed therapy |
| IND-ADVSM-1L-AVAPRITINIB | progression_free_survival | cited | SRC-id hit: SRC-ESMO-AML-2020 | Median not reached (PATHFINDER 24-mo follow-up) |
| IND-ADVSM-1L-MIDOSTAURIN | overall_response_rate | cited | SRC-id hit: SRC-ESMO-AML-2020 | ~28% (Valent/Cheson criteria); ~60% (IWG-MRT-ECNM-modified); D-RIVE |
| IND-ADVSM-1L-MIDOSTAURIN | overall_survival_5y | cited | SRC-id hit: SRC-ESMO-AML-2020 | ASM ~26 mo median OS; SM-AHN ~21 mo; MCL ~9 mo (D-RIVE long-term) |
| IND-ADVSM-1L-MIDOSTAURIN | progression_free_survival | cited | SRC-id hit: SRC-ESMO-AML-2020 | Not formally reported in advanced-SM trial |
