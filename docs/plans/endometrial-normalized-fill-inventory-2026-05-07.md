...
- BMA review blockers: pending_signoff=17, review_required=17
- BMA metadata consistency: ready=17, missing_primary=0, missing_evidence=0, missing_contra=0, guideline_order_mismatch=0
- BMA family groups: BIO-CTNNB1 x1, BIO-DMMR-IHC x9, BIO-FGFR2 x1, BIO-KRAS-G12C x1, BIO-PIK3CA-MUTATION x1, BIO-PIK3R1 x1, BIO-RAS-MUTATION x2, BIO-TP53-MUTATION x1
- BMA review queue: soc_dmmr_family[high] x9, intermediate_family_audit[medium] x3, low_tier_tail[low] x5

### BMA Files

| ID | Biomarker | ESCAT | Review | Review Required | Verified | Path |
|---|---|---|---|---|---|---|
| BMA-CTNNB1-ENDOMETRIAL | BIO-CTNNB1 | IIB | pending_clinical_signoff | True | 2026-05-04 | knowledge_base/hosted/content/biomarker_actionability/bma_ctnnb1_endometrial.yaml |
...
| BMA-FGFR2-MUTATION-ENDOMETRIAL | BIO-FGFR2 | IIA | pending_clinical_signoff | True | 2026-04-27 | knowledge_base/hosted/content/biomarker_actionability/bma_fgfr2_mutation_endometrial.yaml |
...
| BMA-PIK3R1-ENDOMETRIAL | BIO-PIK3R1 | IIB | pending_clinical_signoff | True | 2026-05-04 | knowledge_base/hosted/content/biomarker_actionability/bma_pik3r1_endometrial.yaml |
...
|---|---:|---|---|
| BIO-CTNNB1 | 1 | IIB | BMA-CTNNB1-ENDOMETRIAL |
...
| intermediate_family_audit | medium | 3 | BIO-CTNNB1, BIO-FGFR2, BIO-PIK3R1 | Single-record actionable families with IIA/IIB evidence that need clean review packets. |
...
| Check | Count | IDs |
|---|---:|---|
| Metadata-ready rows | 17 | BMA-CTNNB1-ENDOMETRIAL, BMA-EPCAM-GERMLINE-ENDOMETRIAL, BMA-FGFR2-MUTATION-ENDOMETRIAL, BMA-KRAS-G12C-ENDOMETRIAL, BMA-KRAS-G12D-ENDOMETRIAL, BMA-KRAS-G12V-ENDOMETRIAL, BMA-MLH1-GERMLINE-ENDOMETRIAL, BMA-MLH1-SOMATIC-ENDOMETRIAL, BMA-MSH2-GERMLINE-ENDOMETRIAL, BMA-MSH2-SOMATIC-ENDOMETRIAL, BMA-MSH6-GERMLINE-ENDOMETRIAL, BMA-MSH6-SOMATIC-ENDOMETRIAL, BMA-PIK3CA-HOTSPOT-ENDOMETRIAL, BMA-PIK3R1-ENDOMETRIAL, BMA-PMS2-GERMLINE-ENDOMETRIAL, BMA-PMS2-SOMATIC-ENDOMETRIAL, BMA-TP53-MUT-ENDOMETRIAL |
...
```text
Switch to GPT-5.4-Mini medium. Use `py -3.12 -m scripts.normalized_actionability_coverage --inventory-disease DIS-ENDOMETRIAL --compact-json` as the only inventory input. Produce a source-grounded YAML edit plan only; do not author clinical claims.
```
