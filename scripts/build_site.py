...
def _copy_landing_assets(output_dir: Path) -> list[str]:
    ...
    # MDT.png is referenced as og:image across all generated HTML.
    # MDT-light.png was a former dark-mode variant that no template
    # references; dropped 2026-05-16 to stop shipping ~90 KB dead weight.
    assets = ["MDT.png"]
    copied: list[str] = []
    for name in assets:
        src = src_root / name
