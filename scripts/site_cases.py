...
CASES: list[CaseEntry] = [
    ...
    # ── Wave 1–3 gene-panel biomarker cases (new diseases + biomarker-specific variants) ──
    CaseEntry(
        case_id="bcc-smo-mutant-vismodegib",
        file="patient_bcc_smo_mutant_vismodegib.json",
        label_ua="BCC · SMO W535L — локально-поширений (hedgehog-інгібітор)",
        summary_ua="Чоловік 67, laBCC з активуючою мутацією SMO W535L, нерезектабельний. Двигун обирає HHI (вісмодегіб або сонідегіб) — ESCAT IA. Зупинка (MIKIE) і терапія порятунку цемiплімабом після HHI.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="BCC · SMO W535L — locally advanced (hedgehog inhibitor)",
        summary_en="Man 67, laBCC with SMO W535L activating mutation, unresectable. Engine selects HHI (vismodegib or sonidegib) — ESCAT IA. Break strategy (MIKIE) and cemiplimab salvage post-HHI.",
    ),
    CaseEntry(
        case_id="bcc-ptch1-gorlin-syndrome",
        file="patient_bcc_ptch1_gorlin.json",
        label_ua="BCC · PTCH1 germline — синдром Горліна (множинні BCC, 28р)",
        summary_ua="Жінка 28, синдром Горліна (germline PTCH1 LOF). Множинні BCCs, частина локально-поширені. ESCAT IA: HHI активні; уникати опромінення. Дерматологічне спостереження + краніальна МРТ.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="BCC · PTCH1 germline — Gorlin syndrome (multiple BCCs, age 28)",
        summary_en="Woman 28, Gorlin syndrome (germline PTCH1 LOF). Multiple BCCs, some locally advanced. ESCAT IA: HHI active; avoid radiation. Dermatological surveillance + cranial MRI.",
    ),
    CaseEntry(
        case_id="tgct-csf1r-pexidartinib",
        file="patient_tgct_csf1r_pexidartinib.json",
        label_ua="TGCT · CSF1R надекспресія — дифузний тип, коліно (пексидартиніб)",
        summary_ua="Жінка 34, дифузний TGCT коліна. CSF1R IHC+. Двигун: пексидартиніб 400 мг BID (FDA 2019, ESCAT IA) з REMS. Моніторинг LFT щомісяця перших 8 тижнів; хірургія резервується.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="TGCT · CSF1R overexpression — diffuse-type, knee (pexidartinib)",
        summary_en="Woman 34, diffuse TGCT of the knee. CSF1R IHC+. Engine: pexidartinib 400 mg BID (FDA 2019, ESCAT IA) with REMS. Monthly LFT monitoring for first 8 weeks; surgery reserved.",
    ),
    CaseEntry(
        case_id="epithelioid-sarcoma-smarcb1-tazemetostat",
        file="patient_epithelioid_sarcoma_smarcb1_tazemetostat.json",
        label_ua="Епітеліоїдна саркома · SMARCB1 (INI1) — метастатична (таземетостат)",
        summary_ua="Чоловік 26, проксимальний тип, метастатична епітеліоїдна саркома. INI1 повна втрата (IHC). Двигун: таземетостат 800 мг BID (EZH-202, FDA 2020, ESCAT IA). ORR 15%, CBR 26%.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="Epithelioid Sarcoma · SMARCB1 (INI1) loss — metastatic (tazemetostat)",
        summary_en="Man 26, proximal-type metastatic epithelioid sarcoma. INI1 complete loss (IHC). Engine: tazemetostat 800 mg BID (EZH-202, FDA 2020, ESCAT IA). ORR 15%, CBR 26%.",
    ),
    CaseEntry(
        case_id="lam-tsc1-sirolimus",
        file="patient_lam_tsc1_sirolimus.json",
        label_ua="LAM · TSC1 втрата — спорадична (сиролімус, MILES)",
        summary_ua="Жінка 38, спорадична LAM (TSC1 соматична, VEGF-D 1240 пг/мл). FEV1 52%. Двигун: сиролімус (MILES +11 мл/міс FEV1, FDA 2015, ESCAT IA). Безперервна терапія; моніторинг рівнів 5–15 нг/мл.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="LAM · TSC1 loss — sporadic (sirolimus, MILES trial)",
        summary_en="Woman 38, sporadic LAM (TSC1 somatic loss, VEGF-D 1240 pg/mL). FEV1 52%. Engine: sirolimus (MILES +11 mL/min FEV1, FDA 2015, ESCAT IA). Continuous therapy; target levels 5–15 ng/mL.",
    ),
    CaseEntry(
        case_id="granulosa-cell-foxl2-recurrent",
        file="patient_granulosa_cell_foxl2_recurrent.json",
        label_ua="Гранульозоклітинна пухлина · FOXL2 C134W — рецидивна (BEP / лейпролід)",
        summary_ua="Жінка 54, AGCT стадія III, залишкова хвороба після ДОД. FOXL2 p.C134W підтверджено. Двигун: BEP × 4 або карбоплатин/паклітаксел; лейпролід ад'ювант офф-лейбл. Спостереження інгібін B + АМГ.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="Granulosa Cell Tumor · FOXL2 C134W — recurrent (BEP / leuprolide)",
        summary_en="Woman 54, AGCT stage III with residual disease post-debulking. FOXL2 p.C134W confirmed. Engine: BEP × 4 or carboplatin/paclitaxel; leuprolide adjuvant off-label. Inhibin B + AMH monitoring.",
    ),
    CaseEntry(
        case_id="meningioma-nf2-progressive-2l",
        file="patient_meningioma_nf2_progressive.json",
        label_ua="Менінгіома · NF2 LOF — прогресія після хірургії+ПТ (бевацизумаб офф-лейбл)",
        summary_ua="Жінка 55, WHO grade 2 менінгіома, рецидив після хірургії + ПТ. NF2 LOF (meрлін IHC-). Двигун: бевацизумаб офф-лейбл (ORR ~40–50% ретроспективно; ESCAT IIB). Вступ до дослідження FAK-інгібіторів.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="Meningioma · NF2 loss — progressive after surgery+RT (bevacizumab off-label)",
        summary_en="Woman 55, WHO grade 2 meningioma, recurrence after surgery + RT. NF2 LOF (merlin IHC-). Engine: bevacizumab off-label (ORR ~40–50% retrospective; ESCAT IIB). FAK inhibitor trial enrollment.",
    ),
    CaseEntry(
        case_id="jmml-ptpn11-somatic-allohct",
        file="patient_jmml_ptpn11_somatic.json",
        label_ua="JMML · PTPN11 соматична (не Нунан) — азацитидін + алоТКК",
        summary_ua="Хлопець 2р, JMML з соматичною PTPN11 E76K (germline негативна — не синдром Нунан). Двигун: азацитидін-міст → алоТКК (єдиний curative; ESCAT IIIA). КРИТИЧНО: розрізнення соматична vs germline.",
        badge="Treatment Plan", badge_class="bdg-plan", category="myeloid",
        label_en="JMML · PTPN11 somatic (not Noonan) — azacitidine bridge + alloHCT",
        summary_en="Boy age 2, JMML with somatic PTPN11 E76K (germline negative — not Noonan syndrome). Engine: azacitidine bridge → alloHCT (only curative; ESCAT IIIA). CRITICAL: somatic vs. germline distinction.",
    ),
    CaseEntry(
        case_id="gbm-tert-idh-wt-molecular",
        file="patient_gbm_tert_idh_wt.json",
        label_ua="GBM · TERT C228T + IDH-wt — молекулярна класифікація WHO 2021",
        summary_ua="Чоловік 63, IDH-wt астроцитома grade 3 з TERT C228T + EGFR amp → молекулярний GBM grade 4 (WHO 2021). MGMT неметильований. Двигун: Stupp (RT+TMZ); TERT не змінює терапію — MGMT визначає TMZ-відповідь.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="GBM · TERT C228T + IDH-wt — WHO 2021 molecular classification",
        summary_en="Man 63, IDH-wt astrocytoma grade 3 with TERT C228T + EGFR amp → molecular GBM grade 4 (WHO 2021). MGMT unmethylated. Engine: Stupp (RT+TMZ); TERT does not change therapy — MGMT predicts TMZ response.",
    ),
    CaseEntry(
        case_id="endometrial-ctnnb1-nsmp-highrisk",
        file="patient_endometrial_ctnnb1_nsmp_highrisk.json",
        label_ua="РЕ · CTNNB1 екзон 3 — NSMP high-risk, FIGO IB (карбоплатин/паклітаксел)",
        summary_ua="Жінка 62, FIGO IB ендометріоїдна G2, NSMP-клас, CTNNB1 S45P + L1CAM IHC+. Двигун: переоцінка ризику до high-intermediate → хіміотерапія карб/пакл (ESGO/ESMO/ESTRO 2023). Не лише VBT.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="EC · CTNNB1 exon 3 — NSMP high-risk, FIGO IB (carbo/paclitaxel adjuvant)",
        summary_en="Woman 62, FIGO IB endometrioid G2, NSMP class, CTNNB1 S45P + L1CAM IHC+. Engine: risk reclassification to high-intermediate → carboplatin/paclitaxel adjuvant (ESGO/ESMO/ESTRO 2023). Not VBT alone.",
    ),
    CaseEntry(
        case_id="endometrial-pik3r1-pmmr-advanced",
        file="patient_endometrial_pik3r1_pmmr_advanced.json",
        label_ua="РЕ · PIK3R1 LOF — pMMR прогресія (ленватиніб + пембролізумаб, KEYNOTE-775)",
        summary_ua="Жінка 66, pMMR/MSS ендометріальна карцинома стадія IVB, 2L після платини. PIK3R1 LOF + PTEN IHC-. Двигун: ленватиніб 20 мг + пембролізумаб (KEYNOTE-775; не PIK3R1-специфічно). Алпелізиб — дослідний.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="EC · PIK3R1 LOF — pMMR progression (lenvatinib + pembrolizumab, KEYNOTE-775)",
        summary_en="Woman 66, pMMR/MSS endometrial carcinoma stage IVB, 2L after platinum. PIK3R1 LOF + PTEN IHC-. Engine: lenvatinib 20 mg + pembrolizumab (KEYNOTE-775; not PIK3R1-specific). Alpelisib investigational.",
    ),
    CaseEntry(
        case_id="nsclc-ddr2-squamous-investigational",
        file="patient_nsclc_ddr2_squamous.json",
        label_ua="НМРЛ · DDR2 S768R — плоскоклітинний (дослідний; стандарт — хіміоімунотерапія)",
        summary_ua="Чоловік 71, плоскоклітинний НМРЛ стадія IV, DDR2 S768R, PD-L1 35%. Двигун: стандарт — пембролізумаб + хімія (KEYNOTE-407). DDR2 → ESCAT IIIB; дазатиніб клінічно непідтверджений; дослідження.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="NSCLC · DDR2 S768R — squamous (investigational; standard = chemoimmunotherapy)",
        summary_en="Man 71, squamous NSCLC stage IV, DDR2 S768R, PD-L1 35%. Engine: standard pembrolizumab + chemo (KEYNOTE-407). DDR2 → ESCAT IIIB; dasatinib clinically unconfirmed; clinical trial.",
    ),
    CaseEntry(
        case_id="thyroid-ptc-tert-braf-highrisk",
        file="patient_thyroid_ptc_tert_braf_highrisk.json",
        label_ua="ПТК · TERT C228T + BRAF V600E — РАЙ-рефрактерний (~40× смертність)",
        summary_ua="Жінка 68, ПТК з TERT C228T + BRAF V600E (подвійна мутація → ~40× вища смертність). РАЙ-рефрактерна, легені+кістки. Двигун: ленватиніб 24 мг або сорафеніб 400 мг BID. TERT не змінює лікування — BRAF визначає.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="PTC · TERT C228T + BRAF V600E — RAI-refractory (~40× mortality risk)",
        summary_en="Woman 68, PTC with TERT C228T + BRAF V600E co-mutation (~40× higher mortality). RAI-refractory, lung+bone mets. Engine: lenvatinib 24 mg or sorafenib 400 mg BID. TERT doesn't change treatment — BRAF guides.",
    ),
    CaseEntry(
        case_id="ipmn-gnas-kras-double-positive",
        file="patient_ipmn_gnas_kras_cyst.json",
        label_ua="IPMN/ПКПЗ · GNAS R201H + KRAS G12V — аналіз рідини кісти (хірургія)",
        summary_ua="Чоловік 72, IPMN головної протоки (розширення 11 мм), муральний вузол 6 мм. GNAS R201H + KRAS G12V у рідині кісти + атипові клітини → high-risk stigmata → хірургічне направлення незалежно від GNAS.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="IPMN/PDAC · GNAS R201H + KRAS G12V — cyst fluid analysis (surgical referral)",
        summary_en="Man 72, main-duct IPMN (11 mm dilation), mural nodule 6 mm. GNAS R201H + KRAS G12V in cyst fluid + atypical cytology → high-risk stigmata → surgical referral regardless of GNAS.",
    ),
    # ── Wave 3 variant profiles (additional per-disease examples for try.html dropdown) ──
    CaseEntry(
        case_id="epithelioid-sarcoma-distal-adjuvant",
        file="patient_epithelioid_sarcoma_distal_early.json",
        label_ua="Епітеліоїдна саркома · дистальний тип — R0 резекція (ад'ювант / спостереження)",
        summary_ua="Жінка 22, дистальний тип EpS (палець правої руки), R0 резекція. INI1 IHC−, SMARCB1 двоалельна інактивація NGS. Двигун: спостереження vs ад'ювант ад'ювант (іфосфамід/доксорубіцин офф-лейбл). Таземетостат — при рецидиві.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="Epithelioid Sarcoma · distal type — R0 resected (adjuvant / surveillance)",
        summary_en="Woman 22, distal-type EpS (right index finger), R0 resection. INI1 IHC−, SMARCB1 biallelic NGS. Engine: surveillance vs adjuvant ifosfamide/doxorubicin off-label. Tazemetostat reserved for recurrence.",
    ),
    CaseEntry(
        case_id="plgg-map2k1-pediatric-2l-mek",
        file="patient_lgg_map2k1_pediatric.json",
        label_ua="пНГГ · MAP2K1 K57E — прогресія після карбо/вінкристину (MEK-інгібітор)",
        summary_ua="Хлопець 9р, мозочкова НГГ, MAP2K1 K57E (BRAF-fusіon neg). Прогресія після стандартного карбоплатин+вінкристин. Двигун: траметиніб або бінімeтиніб (MEK-інгібітор, ESCAT IIIA; NCI-COG педіатричний trial). Без дабрафенібу.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="pLGG · MAP2K1 K57E — progression after carbo/vincristine (MEK inhibitor)",
        summary_en="Boy age 9, cerebellar LGG, MAP2K1 K57E (BRAF-fusion negative). Progression after standard carboplatin+vincristine. Engine: trametinib or binimetinib (MEK inhibitor, ESCAT IIIA; NCI-COG peds trial). No dabrafenib.",
    ),
    CaseEntry(
        case_id="granulosa-cell-foxl2-ic-surveillance",
        file="patient_granulosa_cell_early_surveillance.json",
        label_ua="Гранульозоклітинна пухлина · FOXL2 C134W — стадія IC, розрив (спостереження + інгібін B)",
        summary_ua="Жінка 47, AGCT стадія IC, R0 (ТАГ+ДПЯ), розрив під час операції. FOXL2 C134W+ . Двигун: спостереження (ад'ювант BEP дискусійний для IC через розрив; GCIG). Інгібін B + АМГ кожні 3 міс — маркери рецидиву.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="Granulosa Cell Tumor · FOXL2 C134W — stage IC with rupture (surveillance + inhibin B)",
        summary_en="Woman 47, AGCT stage IC, R0 (TAH+BSO), rupture at surgery. FOXL2 C134W+. Engine: surveillance (adjuvant BEP debated for IC-rupture; GCIG). Inhibin B + AMH every 3 months — recurrence markers.",
    ),
    CaseEntry(
        case_id="jmml-ptpn11-monosomy7-allohct",
        file="patient_jmml_monosomy7_highrisk.json",
        label_ua="JMML · PTPN11 D61G + моносомія 7 — high-risk (азацитидін → алоТКК)",
        summary_ua="Дівчинка 3р, JMML з соматичною PTPN11 D61G + моносомія 7 (germline негативна). HbF 71%, тромбоцити 32К. Двигун: high-risk → азацитидін-міст → алоТКК якнайшвидше. Моносомія 7 знижує ймовірність спонтанної ремісії до нуля.",
        badge="Treatment Plan", badge_class="bdg-plan", category="myeloid",
        label_en="JMML · PTPN11 D61G + monosomy 7 — high-risk (azacitidine bridge → alloHCT)",
        summary_en="Girl age 3, JMML with somatic PTPN11 D61G + monosomy 7 (germline negative). HbF 71%, platelets 32K. Engine: high-risk → azacitidine bridge → alloHCT urgently. Monosomy 7 eliminates spontaneous remission probability.",
    ),
    CaseEntry(
        case_id="lam-tsc2-renal-aml-sirolimus",
        file="patient_lam_tsc_associated_renal_aml.json",
        label_ua="LAM · TSC2 germline — ТСК-асоційована + ниркова АМЛ 4.2 см (сиролімус)",
        summary_ua="Жінка 32, ТСК-асоційована LAM (germline TSC2 LOF). FEV1 68%, VEGF-D 950 пг/мл. Ниркова АМЛ 4.2 см. Двигун: сиролімус (MILES; FDA 2015) — показаний для LAM і знижує ризик кровотечі з АМЛ. АМЛ <4 см → спостереження vs емболізація.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="LAM · TSC2 germline — TSC-associated + renal AML 4.2 cm (sirolimus)",
        summary_en="Woman 32, TSC-associated LAM (germline TSC2 LOF). FEV1 68%, VEGF-D 950 pg/mL. Renal AML 4.2 cm. Engine: sirolimus (MILES; FDA 2015) — active for LAM and reduces AML hemorrhage risk. AML at borderline size — embolization discussion.",
    ),
    CaseEntry(
        case_id="meningioma-nf2-grade1-observation",
        file="patient_meningioma_grade1_sporadic.json",
        label_ua="Менінгіома · NF2 LOF — WHO grade 1, Simpson II резекція (спостереження)",
        summary_ua="Жінка 48, WHO grade 1 менінгіома (NF2 сплайсинговий варіант, мерлін IHC−). Simpson grade II резекція. Двигун: спостереження (MRI через 6 міс, потім щорічно). Ад'ювант СРТ лише при рецидиві. Відстежувати NF2 germline.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="Meningioma · NF2 loss — WHO grade 1, Simpson II resection (observation)",
        summary_en="Woman 48, WHO grade 1 meningioma (NF2 splice variant, merlin IHC−). Simpson grade II resection. Engine: observation (MRI at 6 months then annually). Adjuvant SRT only at recurrence. NF2 germline testing recommended.",
    ),
    CaseEntry(
        case_id="tgct-csf1r-localized-recurrent-pexidartinib",
        file="patient_tgct_localized_postsurgery.json",
        label_ua="TGCT · CSF1R IHC+ — локальний (PVNS коліна), рецидив після артроскопії (пексидартиніб)",
        summary_ua="Чоловік 41, локальний TGCT (PVNS коліна), рецидив через 14 міс після артроскопічної синовектомії. CSF1R IHC+. Двигун: 2L пексидартиніб 400 мг BID (FDA 2019, ESCAT IA) з REMS. Моніторинг LFT. Хірургія вже була — TKI є стандартом 2L.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="TGCT · CSF1R IHC+ — localized (PVNS knee), recurrence post-arthroscopy (pexidartinib)",
        summary_en="Man 41, localized TGCT (PVNS knee), recurrence 14 months post-arthroscopic synovectomy. CSF1R IHC+. Engine: 2L pexidartinib 400 mg BID (FDA 2019, ESCAT IA) with REMS. LFT monitoring. Surgery already failed — TKI is 2L standard.",
    ),
