...
CASES: list[CaseEntry] = [
    ...
    CaseEntry(
        ...
        label_ua="DIS-ANAL-SCC — Auto-stub (38% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Anal squamous cell carcinoma (Anal SCC). Фактична наповненість бази для цієї хвороби — 38%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-ANAL-SCC — Auto-stub (38% KB fill)",
        summary_en="Auto-generated minimal profile for Anal squamous cell carcinoma (Anal SCC). Actual KB fill for this disease is 38%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-apl",
        file="auto_apl.json",
    ...
    CaseEntry(
        case_id="auto-bcc",
        file="auto_bcc.json",
        label_ua="DIS-BCC — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Basal cell carcinoma. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-BCC — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Basal cell carcinoma. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-breast",
    ...
    CaseEntry(
        ...
        label_ua="DIS-EPITHELIOID-SARCOMA — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Epithelioid sarcoma. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-EPITHELIOID-SARCOMA — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Epithelioid sarcoma. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
    ...
    CaseEntry(
        ...
        label_ua="DIS-GI-NET — Auto-stub (75% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для GI neuroendocrine tumor (carcinoid). Фактична наповненість бази для цієї хвороби — 75%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-GI-NET — Auto-stub (75% KB fill)",
        summary_en="Auto-generated minimal profile for GI neuroendocrine tumor (carcinoid). Actual KB fill for this disease is 75%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-gist",
        file="auto_gist.json",
    ...
    CaseEntry(
        ...
        label_ua="DIS-GRANULOSA-CELL — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Adult granulosa cell tumor. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-GRANULOSA-CELL — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Adult granulosa cell tumor. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-hcc",
        file="auto_hcc.json",
    ...
    CaseEntry(
        case_id="auto-jmml",
        file="auto_jmml.json",
        label_ua="DIS-JMML — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Juvenile myelomonocytic leukemia. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-JMML — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Juvenile myelomonocytic leukemia. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-lam",
        file="auto_lam.json",
        label_ua="DIS-LAM — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Lymphangioleiomyomatosis. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-LAM — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Lymphangioleiomyomatosis. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
    ...
    CaseEntry(
        ...
        label_ua="DIS-MENINGIOMA — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Meningioma. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-MENINGIOMA — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Meningioma. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-mesothelioma",
        file="auto_mesothelioma.json",
        label_ua="DIS-MESOTHELIOMA — Auto-stub (38% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Malignant mesothelioma. Фактична наповненість бази для цієї хвороби — 38%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-MESOTHELIOMA — Auto-stub (38% KB fill)",
        summary_en="Auto-generated minimal profile for Malignant mesothelioma. Actual KB fill for this disease is 38%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
    ...
    CaseEntry(
        case_id="auto-pnet",
        file="auto_pnet.json",
        label_ua="DIS-PNET — Auto-stub (75% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Pancreatic neuroendocrine tumor. Фактична наповненість бази для цієї хвороби — 75%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-PNET — Auto-stub (75% KB fill)",
        summary_en="Auto-generated minimal profile for Pancreatic neuroendocrine tumor. Actual KB fill for this disease is 75%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
    ...
    CaseEntry(
        ...
        label_ua="DIS-SOFT-TISSUE-SARCOMA — Auto-stub (12% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Soft tissue sarcoma. Фактична наповненість бази для цієї хвороби — 12%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-SOFT-TISSUE-SARCOMA — Auto-stub (12% KB fill)",
        summary_en="Auto-generated minimal profile for Soft tissue sarcoma. Actual KB fill for this disease is 12%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
    ...
    CaseEntry(
        ...
        label_ua="DIS-TESTICULAR-GCT — Auto-stub (38% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Testicular germ cell tumor. Фактична наповненість бази для цієї хвороби — 38%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-TESTICULAR-GCT — Auto-stub (38% KB fill)",
        summary_en="Auto-generated minimal profile for Testicular germ cell tumor. Actual KB fill for this disease is 38%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
        case_id="auto-tgct",
        file="auto_tgct.json",
        label_ua="DIS-TGCT — Auto-stub (0% наповненість)",
        summary_ua="Автогенерований мінімальний профіль для Tenosynovial giant cell tumor. Фактична наповненість бази для цієї хвороби — 0%. Використовується для перевірки end-to-end engine + render — не для клінічних рішень.",
        badge="Auto-stub", badge_class="bdg-stub", category="solid",
        label_en="DIS-TGCT — Auto-stub (0% KB fill)",
        summary_en="Auto-generated minimal profile for Tenosynovial giant cell tumor. Actual KB fill for this disease is 0%. Used to verify end-to-end engine + render — not for clinical decisions.",
    ),
    CaseEntry(
