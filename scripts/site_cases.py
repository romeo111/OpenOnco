...
CASES: list[CaseEntry] = [
    ...
    CaseEntry(
        ...
        summary_ua="Синтетичний профіль: BIO-KIT (D816V (activation loop, exon 17 — rare in GIST primary; seco). ESCAT IIA. Engine: 2 tracks. Не для клінічних рішень.",
        badge="BMA", badge_class="bdg-stub", category="solid",
        label_en="DIS-GIST · BIO-KIT (ESCAT IIA)",
        summary_en="Synthetic profile: BIO-KIT (D816V (activation loop, exon 17 — rare in GIST primary; seco). ESCAT IIA. Engine: 2 tracks. Not for clinical decisions.",
    ),
    CaseEntry(
