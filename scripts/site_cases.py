...
CASES: list[CaseEntry] = [
    ...
    CaseEntry(
        case_id="verified-testicular-gct-l2-tip-gct-salvage",
        file="patient_verified_testicular_gct_l2_tip_gct_salvage.json",
        label_ua="TESTICULAR-GCT · 2L · TIP-GCT-SALVAGE",
        summary_ua="Перевірений end-to-end приклад для Testicular germ cell tumor — лінія 2, режим TIP-GCT-SALVAGE. Автоматично згенеровано з IND-GCT-SALVAGE-2L-TIP; engine обирає його як план за замовчуванням.",
        badge="Treatment Plan", badge_class="bdg-plan", category="solid",
        label_en="TESTICULAR-GCT · L2 · TIP-GCT-SALVAGE",
        summary_en="Verified end-to-end example for Testicular germ cell tumor — line 2, regimen TIP-GCT-SALVAGE. Auto-synthesised from IND-GCT-SALVAGE-2L-TIP; engine routes to it as the default plan.",
    ),
    CaseEntry(
