...
body.home-page .lang-switch .lang-current {
  background: var(--green-700);
  color: white;
}
body.home-page .lang-switch .lang-other {
  color: var(--gray-700);
}
body.home-page .lang-switch .lang-other:hover {
  background: transparent;
  color: var(--green-700);
}
body.home-page .btn-cta-try {
  background: var(--green-700);
  box-shadow: none;
}
body.home-page .btn-cta-try:hover {
  transform: none;
  box-shadow: none;
  filter: none;
}
