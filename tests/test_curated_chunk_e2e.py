...
CASE_TREATMENT_GOLDENS: dict[str, str] = {
    ...
    "patient_aml_secondary_cpx351.json": "IND-AML-1L-7-3",
    ...
    "patient_dlbcl_primary_refractory_loncast_post_pola.json": "IND-DLBCL-2L-POLA-R-BENDAMUSTINE",
    ...
    "patient_esophageal_adeno_neoadj_cross_then_nivo.json": "IND-ESOPH-RESECTABLE-CROSS-NEOADJUVANT",
    ...
    "patient_melanoma_braf_wt_pembro_mono.json": "IND-MELANOMA-METASTATIC-1L-NIVO-IPI",
    ...
    "patient_pdac_metastatic_folfirinox_fit.json": "IND-PDAC-METASTATIC-1L-GEM-NAB-PAC",
    ...
    "patient_rcc_imdc_int_nivo_ipi.json": "IND-RCC-METASTATIC-1L-PEMBRO-AXI",
