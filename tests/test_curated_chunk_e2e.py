...
CASE_TREATMENT_GOLDENS: dict[str, str] = {
    ...
    "patient_breast_tnbc_neoadj_kn522_pembro_chemo.json": "IND-BREAST-TNBC-EARLY-NEOADJUVANT",
    ...
    "patient_hnscc_cps_high_pembro_mono.json": "IND-HNSCC-RM-1L-PEMBRO-CHEMO",
