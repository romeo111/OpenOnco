...
def test_core_bundle_under_size_ceiling(bundle_out: dict):
    """Core bundle target: ≤2.6 MB compressed today (~2.50 MB observed
    2026-05-01 after EN-render translation overrides landed), with
    eventual goal ≤1.5 MB once more disease-scoped content (drugs,
    regimens, indications) is moved out of core into per-disease
    modules. Ceiling sized for headroom; tighten as the split matures."""
